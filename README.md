...
The goal of the HamMessenger project is to create a device that uses ham radio as a medium for sending and receiving text messages. HamMessenger exists also to promote amateur radio, electronics, and progrogramming. The project is currently in a beta prototyping stage with minimum functionality. 
